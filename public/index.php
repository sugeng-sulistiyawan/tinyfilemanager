                    ...
                    <div class="card-wrapper">
                        <div class="card fat" data-bs-theme="<?php echo FM_THEME; ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                        <div class="brand">
                                            <img class="mb-2" src="https://sipintar.rssoedomo.com/images/icon.png" alt="">
                                        </div>
                        ...
                        <div class="footer text-center">
                            <div class="text-xs font-normal text-gray-500">
                                &copy; <?php echo date('Y'); ?> Made with ❤️ by <strong>IT RSUD</strong>
                            </div>
                        </div>
                    </div>
                </div>
...
?>
    ...
    <head>
        ...
        <?php if ($favicon_path) {
            ...
            echo '<link rel="icon" sizes="512x512" href="https://sipintar.rssoedomo.com/images/icons/icon-512x512.png">';
        } ?>
...
?>
    ...
    <head>
        ...
        <title><?php echo fm_enc(APP_TITLE) ?> | <?php echo (isset($_GET['view']) ? $_GET['view'] : ((isset($_GET['edit'])) ? $_GET['edit'] : "RSUD dr. Soedomo")); ?></title>
        <?php print_external('pre-jsdelivr'); ?>
